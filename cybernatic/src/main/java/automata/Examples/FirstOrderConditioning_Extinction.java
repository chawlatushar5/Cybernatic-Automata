...
public class FirstOrderConditioning_Extinction {
    ...
    public static void FOCExtinction() throws Exception {
        ...
        for (int i=0; i<60; i++) {
            System.out.println("Starting learning Experiment : "+ Math.addExact(i,1));
        ...
        for (int i=0; i<60; i++) {
            System.out.println("Starting Extinction Experiment : "+ Math.addExact(i,1));
            Cybernatic.process(new SymbolStrengthPairs(allInputs.addNewAlphabet(CSPLus, 100.0)));
            Cybernatic.process(new SymbolStrengthPairs(allInputs.addNewAlphabet(CSMinus, 100.0)));
            Cybernatic.process(new SymbolStrengthPairs(allInputs.addNewAlphabet(Epsilon, 100.0)));
        }
